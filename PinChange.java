...
public class PinChange extends JFrame implements ActionListener{
    ...
    PinChange(String pinnumber){
       ...
       // setLayout(null);
        ...
        l1.setBounds(180,220,150,35);
        l4.add(l1);
        
        l2.setBounds(120,260,150,35);
        l4.add(l2);
        
        l3.setBounds(120,290,200,35);
        l4.add(l3);
        
        t1.setBounds(220,260,140,25);
        l4.add(t1);
        
        t2.setBounds(265,290,140,25);
        l4.add(t2);
        
        b1.setBounds(270,375,130,25);
        l4.add(b1);
        
        b2.setBounds(270,405,130,25);
        l4.add(b2);
